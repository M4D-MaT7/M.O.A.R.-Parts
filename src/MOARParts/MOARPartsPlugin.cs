...
public class MOARPartsPlugin : BaseSpaceWarpPlugin
{
    ...
    [PublicAPI] public static MOARPartsPlugin Instance { get; set; }
    ...
    // AppBar button IDs
    private const string ToolbarFlightButtonID = "BTN-MOARPartsFlight";
    private const string ToolbarOabButtonID = "BTN-MOARPartsOAB";
    private const string ToolbarKscButtonID = "BTN-MOARPartsKSC";
    ...
    public override void OnInitialized()
    {
        ...
        Harmony.CreateAndPatchAll(typeof(MOARPartsPlugin).Assembly);
    ...
    {
        GUILayout.Label("M.O.A.R.-Parts - Revival of beloved KSP1 parts");
